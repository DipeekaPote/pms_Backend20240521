...
const TaskTemplate = require('../../models/Workflow/taskTemplateModel');
...
const createTaskTemplate = async (req, res) => {
    const { templatename, status, description, taskassignees, tags, priority, absolutedates, startsin, startsinduration, duein, dueinduration, startdate, enddate, subtasks, active } = req.body;
    ...
    try {
        ...
        const newTaskTemplate = await TaskTemplate.create({ templatename, status, description, taskassignees, tags, priority, absolutedates, startsin, startsinduration, duein, dueinduration, startdate, enddate, subtasks, active});
